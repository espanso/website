    ...
    return (
        <div className={styles.container}>
                        ...
                        <TypeIt
                            ...
                            getBeforeInit={(instance) => {
                                instance
                                    ...
                                    .type(
                                        "Hey ,<br/><br/><br/><br/>Best regards,<br/>Federico",
                                    )
                                    .options({
                                        speed: 1,
                                    })
                ...
                description={
                    ...
                    >
                        <p>
                            ...
                            <span className={styles.highlight}>templates</span>{" "}
                            once and let Espanso do the rest for you.
                            <br />
                            <br />
                            Customer support replies, sales pitches, medical
                            reports, you name it. Espanso got you covered.
                        </p>
                    </FeatureDescription>
                }
            />
                ...
                description={
                    ...
                    >
                        <p>
                            ...
                            and Espanso’s{" "}
                            <span className={styles.highlight}>search bar</span>{" "}
                            will open, letting you search for the perfect
                            snippet.
                        </p>
                    </FeatureDescription>
                }
                        ...
                        <TypeIt
                            ...
                            getBeforeInit={(instance) => {
                                instance
                                    ...
                                    .pause(2000)
                                    .type(
                                        "<br/><br/>This is so funny <b>:joy</b>",
                                    )
                                    .pause(400)
                                    .options({
                                        deleteSpeed: 5,
                ...
                description={
                    ...
                    >
                        <p>
                            ...
                            <span className={styles.highlight}>dates</span>.
                            Espanso makes it easy to use them, both past and
                            future ones.
                            <br />
                            <br />
                            Bring{" "}
                            <span className={styles.highlight}>emojis</span> 🤠
                            in all your favorite apps, one shortcut away.
                        </p>
                    </FeatureDescription>
                }
            />
                ...
                description={
                    ...
                    >
                        <p>
                            ...
                            community on the{" "}
                            <Link to="https://hub.espanso.org">
                                Espanso Hub
                            </Link>
                            .
                            <br />
                            <br />
                            Need to insert mathematical notation? Or perhaps
                            german accents? We got a package for them.
                            <br />
                ...
                description={
                    ...
                    >
                        <p>
                            ...
                            snippets with{" "}
                            <span className={styles.highlight}>shell</span>{" "}
                            commands or{" "}
                            ...
                            <br />
                            <br />
                            No more copy-pasting from the terminal, inject the
                            output into applications directly.
                        </p>
                    </FeatureDescription>
                }
            />
                ...
                description={
                    ...
                    >
                        <p>
                            ...
                            to handle complex workflows, creating templates that
                            can be reused with ease.
                            <br />
                            <br />
                            You can even forward form values into custom
                            scripts, opening up endless possibilities.
                        </p>
                    </FeatureDescription>
                }
            />
            ...
            <div className={styles["more-features-container"]}>
                ...
                >
                    <p>
                        Espanso works with most applications, so you can boost
                        your productivity everywhere.
                    </p>
                </SmallFeature>
                <SmallFeature
                ...
                >
                    <p>
                        Espanso follows a Unix-like configuration philosophy,
                        using simple files. Though a GUI is planned in the
                        future.
                    </p>
                </SmallFeature>
                <SmallFeature
