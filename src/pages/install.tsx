...
export default function Install() {
    return (
        <div className={styles.container}>
            <Head>
                <title>
                    Installation - Espanso - A Privacy-first, Cross-platform
                    Text Expander
                </title>
                <link
                    rel="shortcut icon"
                ...
                <div className={styles.targets}>
                    <div className={styles.target}>
                        ...
                        <a
                            ...
                            href={getStableDownloadLink(
                                "WIN_INSTALLER_DOWNLOAD_URL",
                            )}
                            onClick={(e) => {
                                e.preventDefault();
                                window.open(
                                    getStableDownloadLink(
                                        "WIN_INSTALLER_DOWNLOAD_URL",
                                    ),
                                );
                                window.location =
            ...
            <div className={styles["install-section"]}>
                ...
                <p>
                    This is the legacy edition of Espanso. Given that this
                    version is no longer in active development, we recommend
                    users to choose the new version instead, which comes with
            ...
            <p className={styles.attribution}>
                ...
                <a href="https://commons.wikimedia.org/wiki/File:Windows_logo_-_2012.svg">
                    Original work: MicrosoftFile:Windows 8 logo and
                    wordmark.svg: Multiple editors; see image description
                    pageThis work: Fry1989
                </a>
