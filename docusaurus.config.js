...
module.exports = {
  ...
  customFields: {
    LINUX_X11_APP_IMAGE_DOWNLOAD_URL:
      "https://github.com/federico-terzi/espanso/releases/download/v2.1.2-alpha/Espanso-X11.AppImage",
    MAC_INTEL_DOWNLOAD_URL:
      "https://github.com/federico-terzi/espanso/releases/download/v2.1.2-alpha/Espanso-Mac-Intel.zip",
    MAC_M1_DOWNLOAD_URL:
      "https://github.com/federico-terzi/espanso/releases/download/v2.1.2-alpha/Espanso-Mac-M1.zip",
    WIN_INSTALLER_DOWNLOAD_URL:
      "https://github.com/federico-terzi/espanso/releases/download/v2.1.2-alpha/Espanso-Win-Installer-x86_64.exe",
