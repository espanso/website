...
const CURRENT_STABLE_VERSION = "v2.2.5";
...
module.exports = {
  ...
  customFields: {
    ...
    LINUX_X11_DEB_DOWNLOAD_URL:
      "https://github.com/espanso/espanso/releases/latest/download/espanso-debian-x11-amd64.deb",
    ...
    WIN_PORTABLE_DOWNLOAD_URL:
      "https://github.com/espanso/espanso/releases/latest/download/Espanso-Win-Portable-x86_64.zip",
  },
  plugins: [
