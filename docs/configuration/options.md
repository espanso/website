...
`max_form_height` | Constrains the height of [forms](../../matches/forms.md). | Number of pixels  | 500 | Yes
`max_form_width`  | Constrains the width of [forms](../../matches/forms.md).  | Number of pixels | 700 | Yes
