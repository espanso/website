...
you should prefer the built-in [Match Disambiguation](./basics.md/#match-disambiguation) feature.
...
For more information, check out the [Variables](variables.md) section.
