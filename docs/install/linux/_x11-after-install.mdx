...
At this point, you are ready to use espanso by registering it first as a Systemd service and then starting it with (if these do not work, make sure you execute them as an ordinary user, i.e. not as root or admin):
