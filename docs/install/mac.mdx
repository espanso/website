...
The easiest way to install Espanso is by downloading the disk image. 
...
After you've downloaded the image, open it and drag the app into your `/Applications` folder.
