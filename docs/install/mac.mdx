...
Because Espanso is hosted outside the core homebrew repository, and to be sure of downloading the latest version, you may wish to first add the appropriate _tap_ by running the following command inside a terminal:
