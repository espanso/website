...
<div className="">
<a className="btn btn-lg mybtn mb-4" href={siteConfig.customFields.WIN_INSTALLER_DOWNLOAD_URL} role="button">Download the Installer (x64)</a>
<a className="btn btn-lg mybtn mb-4" href={siteConfig.customFields.WIN_PORTABLE_DOWNLOAD_URL} role="button">Download Portable zip (x64)</a>
</div>
