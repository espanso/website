...
* Install the required linux packages:
  * On **Ubuntu/Debian** run `sudo apt update && sudo apt install build-essential git libx11-dev libxtst-dev libxkbcommon-dev libdbus-1-dev ^libwxgtk3\.[0-9].*-dev$ libssl-dev`
...
* Install the required linux packages:
  * On **Ubuntu/Debian** run `sudo apt update && sudo apt install build-essential git wl-clipboard libxkbcommon-dev libdbus-1-dev ^libwxgtk3\.[0-9].*-dev$ libssl-dev`
